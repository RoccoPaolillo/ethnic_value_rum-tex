...
# Dataset formation
# basic1 <- read.csv("DATA/03_03_2022/basic.csv",sep =",",skip = 6)
# basic2 <- read.csv("DATA/03_03_2022/basic_2.csv",sep =",",skip = 6)
# basic_all <- rbind(basic1,basic2)
# basic_all$ID <- "basic"
# 
# ethnicsize <- read.csv("DATA/03_03_2022/ethnicsize_10.csv",sep =",",skip = 6)
# ethnicsize2 <- read.csv("DATA/03_03_2022/ethnicsize_10_2.csv",sep =",",skip = 6)
# ethnicsize$relative_size <- "ethnic"
# ethnicsize_all <- rbind(ethnicsize,ethnicsize2)
# ethnicsize_all$ID <- "ethnicsize"
# 
# 
# valuesize <- read.csv("DATA/03_03_2022/valuesize_10.csv",sep =",",skip = 6)
# valuesize2 <- read.csv("DATA/03_03_2022/valuesize_10_2.csv",sep =",",skip = 6)
# valuesize$relative_size <- "value"
# valuesize_all <- rbind(valuesize,valuesize2)
# valuesize_all$ID <- "valuesize"
# 
# sens_con <- read.csv("DATA/03_03_2022/sens_con.csv",sep =",",skip = 6)
# sens_con2 <- read.csv("DATA/03_03_2022/sens_con_2.csv",sep =",",skip = 6)
# sens_con_all <- rbind(sens_con,sens_con2)
# sens_con_all$ID <- "sens_con"
# 
# sens_lib <- read.csv("DATA/03_03_2022/sens_lib.csv",sep =",",skip = 6)
# sens_lib2 <- read.csv("DATA/03_03_2022/sens_lib_2.csv",sep =",",skip = 6)
...
df_secf <- read.csv("df_secf.csv",sep = ",") 

df_secf <- rbind(df_secf,sec_etlib) # combined the two datasets


df_secf <- df_secf %>% select(
