...
Fig: \ref{fig:libfsecc} focuses on change in secondary ß ethnic of liberals for all levels of $w$, showing results for conservatives (top row) and liberals (bottom row). Fig: \ref{fig:confsecc} repeats for change in secondary ß value of conservatives

Fig: \ref{fig:libfsecc} and Fig: \ref{fig:confsecc} show all levels of $w$ for secondary preference of liberals or conservatives. 

Fig. \ref{fig:secfdom} is a filtered and more text-wise combination of Fig: \ref{fig:libfsecc} and Fig: \ref{fig:confsecc}. In all conditions we have too much information in the figures. For sake of simplicity we could decide:
1) Keep Fig. \ref{fig:secfdom} in the text, deleting what are now Fig: \ref{fig:bsl_dom}, equal to $w = 0$ and \ref{fig:bsl_sec} equal to $w = 1$ and leave Fig: \ref{fig:libfsecc} and Fig: \ref{fig:confsecc} in an Annex
2) Leave as it is now with \ref{fig:bsl_dom} and \ref{fig:bsl_sec}, and still Fig: \ref{fig:libfsecc} and Fig: \ref{fig:confsecc} in an Annex
