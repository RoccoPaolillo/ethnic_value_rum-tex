...
details. The origin of the axes equals to all agents holding
\(\beta = 0\), i.e.~extreme randomness, for both dominant and secondary
preference in their relocation decision, so to relocate randomly from
the initial distribution and generate no segregation. Moving along the
diagonal, dominant preference of agents is equal to secondary preference
