...
author: 
    ...
    | Andreas Flache
    | 
    | **` HERE SOME NOTES TO BEAR IN MIND - test `**
...
seg_vis <- function(db,var_seg,var_seg_y,var_seg_tit,sv_tit){
  
ethlibmaj.labs <- c("w_e lib maj = 0", "w_e lib maj = 0.5", "w_e lib maj = 1")
names(ethlibmaj.labs) <- c("0", "0.5", "1")

ethlibmin.labs <- c("w_e lib min = 0", "w_e lib min = 0.5", "w_e lib min = 1")
names(ethlibmin.labs) <- c("0", "0.5", "1")
...
pic <-  db %>% ggplot(aes(x = dominant, y = var_seg, color = as.factor(liberal_maj ))) + geom_point() + geom_line() + facet_grid( eth_lib_min ~ eth_lib_maj, scales = "free_y", 
  labeller = labeller(eth_lib_maj = ethlibmaj.labs, eth_lib_min = ethlibmin.labs)) +
 ylab(var_seg_y) +
  xlab("ß dominant") +
  ...
  ggsave(paste0("images/",sv_tit,".jpg"),pic)

pic
}

et_sq_bl_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$et_sq_bl_m,"Ethnic Exposure", "Conservative Native","et_sq_bl_m")
vl_sq_bl_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$vl_sq_bl_m,"Value Exposure", "Conservative Native","vl_sq_bl_m")
et_cl_bl_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$et_cl_bl_m,"Ethnic Exposure", "Liberal Native","et_cl_bl_m")
vl_cl_bl_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$vl_cl_bl_m,"Value Exposure", "Liberal Native","vl_cl_bl_m")

et_sq_or_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$et_sq_or_m,"Ethnic Exposure", "Conservative Migrant", "et_sq_or_m")
vl_sq_or_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$vl_sq_or_m,"Value Exposure", "Conservative Migrant","vl_sq_or_m")
et_cl_or_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$et_cl_or_m,"Ethnic Exposure", "Liberal Migrant","et_cl_or_m")
vl_cl_or_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$vl_cl_or_m,"Value Exposure", "Liberal Migrant","vl_cl_or_m")

cls_et_sq_bl_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$cls_et_sq_bl_m,"Ethnic Cluster", "Conservative Native","cls_et_sq_bl_m")
cls_vl_sq_bl_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$cls_vl_sq_bl_m,"Value Cluster", "Conservative Native","cls_vl_sq_bl_m")
cls_et_cl_bl_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$cls_et_cl_bl_m,"Ethnic Cluster", "Liberal Native","cls_et_cl_bl_m")
cls_vl_cl_bl_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$cls_vl_cl_bl_m,"Value Cluster", "Liberal Native","cls_vl_cl_bl_m")

cls_et_sq_or_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$cls_et_sq_or_m,"Ethnic Cluster", "Conservative Migrant","cls_et_sq_or_m")
cls_vl_sq_or_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$cls_vl_sq_or_m,"Value Cluster", "Conservative Migrant","cls_vl_sq_or_m")
cls_et_cl_or_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$cls_et_cl_or_m,"Ethnic Cluster", "Liberal Migrant","cls_et_cl_or_m")
cls_vl_cl_or_m <- seg_vis(df[df$ID == "valuesize",],df[df$ID == "valuesize",]$cls_vl_cl_or_m,"Value Cluster", "Liberal Migrant","cls_vl_cl_or_m")


## majority/minority condition


seg_vis_mj <- function(db,var_seg,var_seg_y,var_seg_tit,sv_tit){
...
mj_et_sq_bl_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$et_sq_bl_m,"Ethnic Exposure", "Conservative Majority","mj_et_sq_bl_m")
mj_vl_sq_bl_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$vl_sq_bl_m,"Value Exposure", "Conservative Majority","mj_vl_sq_bl_m")
mj_et_cl_bl_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$et_cl_bl_m,"Ethnic Exposure", "Liberal Majority","mj_et_cl_bl_m")
mj_vl_cl_bl_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$vl_cl_bl_m,"Value Exposure", "Liberal Majority","mj_vl_cl_bl_m")

mj_et_sq_or_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$et_sq_or_m,"Ethnic Exposure", "Conservative Minority","mj_et_sq_or_m")
mj_vl_sq_or_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$vl_sq_or_m,"Value Exposure", "Conservative Minority","mj_vl_sq_or_m")
mj_et_cl_or_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$et_cl_or_m,"Ethnic Exposure", "Liberal Minority","mj_et_cl_or_m")
mj_vl_cl_or_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$vl_cl_or_m,"Value Exposure", "Liberal Minority","mj_vl_cl_or_m")

mj_cls_et_sq_bl_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$cls_et_sq_bl_m,"Ethnic Cluster", "Conservative Majority","mj_cls_et_sq_bl_m")
mj_cls_vl_sq_bl_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$cls_vl_sq_bl_m,"Value Cluster", "Conservative Majority","mj_cls_vl_sq_bl_m")
mj_cls_et_cl_bl_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$cls_et_cl_bl_m,"Ethnic Cluster", "Liberal Majority","mj_cls_et_cl_bl_m")
mj_cls_vl_cl_bl_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$cls_vl_cl_bl_m,"Value Cluster", "Liberal Majority","mj_cls_vl_cl_bl_m")

mj_cls_et_sq_or_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$cls_et_sq_or_m,"Ethnic Cluster", "Conservative Minority","mj_cls_et_sq_or_m")
mj_cls_vl_sq_or_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$cls_vl_sq_or_m,"Value Cluster", "Conservative Minority","mj_cls_vl_sq_or_m")
mj_cls_et_cl_or_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$cls_et_cl_or_m,"Ethnic Cluster", "Liberal Minority","mj_cls_et_cl_or_m")
mj_cls_vl_cl_or_m <- seg_vis_mj(df[df$ID == "ethnicsize",],df[df$ID == "ethnicsize",]$cls_vl_cl_or_m,"Value Cluster", "Liberal Minority","mj_cls_vl_cl_or_m")


##

ggpubr::ggarrange(et_sq_bl_m,vl_sq_bl_m, common.legend = TRUE, legend = "bottom")
