...
Andreas Flache\\
~\\
\textbf{\texttt{HERE\ SOME\ NOTES\ TO\ BEAR\ IN\ MIN}}~\\
\textbf{\texttt{Added\ material\ secondary\ preference\ function\ of\ dominant\ df\_secf.csv\ and\ .nlogo}}~\\
\textbf{\texttt{To\ include\ figure\ on\ df\_secf.csv}}~\\}
\date{25/08/21 16:21}
