...
seg_vis <- function(rel_siz,db,var_seg,var_seg_y,var_seg_tit){
...
pic <-  db %>% ggplot(aes(x = dominant, y = var_seg, color = as.factor(liberal_maj ))) + geom_point() + geom_line() + facet_grid( eth_lib_min ~ eth_lib_maj, scales = "free_y", 
 ...
 ylab(var_seg_y) +
  ...
  labs(title = rel_siz , subtitle = var_seg_tit) +
  # ggtitle(var_seg_tit) +
  # ggsubtitle(rel_siz) +
  theme_bw() +
...
et_sq_bl_m <- seg_vis("Equal ethnic size",df[df$ID == "valuesize",],df[df$ID == "valuesize",]$et_sq_bl_m,"Ethnic Exposure", "Conservative Blue")
vl_sq_bl_m <- seg_vis("Equal ethnic size",df[df$ID == "valuesize",],df[df$ID == "valuesize",]$vl_sq_bl_m,"Value Exposure", "Conservative Blue")
et_cl_bl_m <- seg_vis("Equal ethnic size",df[df$ID == "valuesize",],df[df$ID == "valuesize",]$et_cl_bl_m,"Ethnic Exposure", "Liberal Blue")
vl_cl_bl_m <- seg_vis("Equal ethnic size",df[df$ID == "valuesize",],df[df$ID == "valuesize",]$vl_cl_bl_m,"Value Exposure", "Liberal Blue")

et_sq_or_m <- seg_vis("Equal ethnic size",df[df$ID == "valuesize",],df[df$ID == "valuesize",]$et_sq_or_m,"Ethnic Exposure", "Conservative Orange")
vl_sq_or_m <- seg_vis("Equal ethnic size",df[df$ID == "valuesize",],df[df$ID == "valuesize",]$vl_sq_or_m,"Value Exposure", "Conservative Orange")
et_cl_or_m <- seg_vis("Equal ethnic size",df[df$ID == "valuesize",],df[df$ID == "valuesize",]$et_cl_or_m,"Ethnic Exposure", "Liberal Orange")
vl_cl_or_m <- seg_vis("Equal ethnic size",df[df$ID == "valuesize",],df[df$ID == "valuesize",]$vl_cl_or_m,"Value Exposure", "Liberal Orange")
