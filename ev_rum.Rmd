...
Fig. \ref{fig:secfdom} shows the increase in secondary preference equal  to $ß \ dominant * w$
...
# Annex A: ß secondary liberal = ß dominant * w



```{r lib_fsec_all, fig.width = 10,  fig.pos = "H", fig.cap="Increase ß ethnic liberal, all levels w", warning=FALSE}
...
```{r con_fsec_all, fig.width = 10,  fig.pos = "H", fig.cap="Increase ß value conservative, all levels w", warning=FALSE}
