...
date: "Uploaded abm sec ratio of dominant, First the experiments section, then delete modeling surplus and text intro, simulation other levels `r format(Sys.time(), '%d/%m/%y %H:%M')`"
