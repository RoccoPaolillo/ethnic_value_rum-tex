...
\textbf{\texttt{Fig\ 4\ shows\ ß\ secondary\ =\ ß\ dominant\ *\ w\ (df\_secf.csv)}}~\\
\textbf{\texttt{Fig\ 4\ could\ substitute\ fig.\ 5\ and\ 7.\ Only\ 3\ levels\ w\ shown}}~\\
\textbf{\texttt{Annex\ A\ shows\ all\ level\ of\ w}}~\\}
\date{06/09/21 01:08}
...
Fig. \ref{fig:secfdom} shows the increase in secondary preference equal
to \(ß \ dominant * w\)

\begin{figure}[H]
\includegraphics[width=1\linewidth]{ev_rum_files/figure-latex/secfdom-1} \caption{Baseline condition, ß secondary as function of ß dominant. Comparison increase in ß ethnic liberal or ß value conservative}\label{fig:secfdom}
\end{figure}
...
\hypertarget{annex-a-uxdf-secondary-liberal-uxdf-dominant-w}{%
\section{Annex A: ß secondary liberal = ß dominant *
w}\label{annex-a-uxdf-secondary-liberal-uxdf-dominant-w}}

\begin{figure}
\centering
\includegraphics{ev_rum_files/figure-latex/lib_fsec_all-1.pdf}
\caption{Increase ß ethnic liberal, all levels w}
\end{figure}

\begin{figure}
\centering
\includegraphics{ev_rum_files/figure-latex/con_fsec_all-1.pdf}
\caption{Increase ß value conservative, all levels w}
\end{figure}
